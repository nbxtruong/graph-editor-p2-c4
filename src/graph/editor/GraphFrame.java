...
public class GraphFrame extends JFrame {
	...
	public GraphFrame(FramesController controller) {
		...
		JButton square = addShapeButton(toolbar, GraphComponent.SQUARE);
		square.doClick();
		addShapeButton(toolbar, GraphComponent.CIRCLE);
		addShapeButton(toolbar, GraphComponent.ARC);
	...
	private JButton addShapeButton(JToolBar toolbar, final String type) {
		JButton button = new JButton(type);
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				component.setShapeType(type);
			}
		});
		toolbar.add(button);
		return button;
